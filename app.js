...
// 学习页的数据
const Study = require("./routes/study/study")

// 聊天室, 暴露出来的为一个函数
const Socket = require("./routes/study/socket")
...
// 返回所有inputleonard,做分享页leonard的搜索框用了
app.get("/share/blogs/inputTitleGetLeonard", Share)
// 搜索的时候根据id查到leonard
app.get("/share/blogs/GetLeonardById", Share)
